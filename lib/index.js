...
var Thumb = function (disabled, currentThumbDiameter, thumbBackground) { return Ae(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n\n    boxSizing: border-box;\n    border: none;\n    width: ", "em;\n    height: ", "em;\n    border-radius: 50%;\n    border-style: solid;\n    border-color: #faf6f6;\n    border-width: 0.37em;\n    box-shadow: ", ";\n    background: ", ";\n  }\n"], ["\n\n    boxSizing: border-box;\n    border: none;\n    width: ", "em;\n    height: ", "em;\n    border-radius: 50%;\n    border-style: solid;\n    border-color: #faf6f6;\n    border-width: 0.37em;\n    box-shadow: ", ";\n    background: ", ";\n  }\n"])), currentThumbDiameter, currentThumbDiameter, disabled ? '0.1em 0.1em 0.3em 0 rgba(0, 0, 0, 0.25)' : '0.1em 0.1em 0.3em 0 rgba(0, 0, 0, 0.75)', disabled ? '#d0d' : thumbBackground); };
var Track = function (disabled, trackBackground) { return Ae(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  box-sizing: border-box;\n  border: none;\n  height: ", "em;\n  border-radius: ", "em;\n  background: ", ";\n"], ["\n  box-sizing: border-box;\n  border: none;\n  height: ", "em;\n  border-radius: ", "em;\n  background: ", ";\n"])), trackHeight, trackHeight / 2, disabled ? '#ddd' : trackBackground); };
var Input = styled.input(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\ntouch-action: none;\n-webkit-appearance: none;\nwidth: 100%;\nheight: ", "em;\nmargin: 0;\npadding: 0;\nfont: 1em/1 arial, sans-serif;\n\n&::-webkit-slider-runnable-track {", ";}\n&::-moz-range-track {", ";}\n&::-ms-track {", ";}\n&::-webkit-slider-thumb {\n  -webkit-appearance: none;\n  margin-top: ", "em;\n  &:active {\n    margin-top: ", "em;\n    width: ", "em;\n    height: ", "em;\n  }\n\n  @media (hover: hover) {\n    &:hover {\n      margin-top: ", "em;\n      width: ", "em;\n      height: ", "em;\n    }\n  }\n\n  ...", ";\n\n}\n&::-moz-range-thumb { \n  ", ";\n}\n&::-ms-thumb { \n  marginTop: 0; \n  ...", ";\n}\n&::-ms-tooltip { display: none };\n"], ["\ntouch-action: none;\n-webkit-appearance: none;\nwidth: 100%;\nheight: ", "em;\nmargin: 0;\npadding: 0;\nfont: 1em/1 arial, sans-serif;\n\n&::-webkit-slider-runnable-track {", ";}\n&::-moz-range-track {", ";}\n&::-ms-track {", ";}\n&::-webkit-slider-thumb {\n  -webkit-appearance: none;\n  margin-top: ", "em;\n  &:active {\n    margin-top: ", "em;\n    width: ", "em;\n    height: ", "em;\n  }\n\n  @media (hover: hover) {\n    &:hover {\n      margin-top: ", "em;\n      width: ", "em;\n      height: ", "em;\n    }\n  }\n\n  ...", ";\n\n}\n&::-moz-range-thumb { \n  ", ";\n}\n&::-ms-thumb { \n  marginTop: 0; \n  ...", ";\n}\n&::-ms-tooltip { display: none };\n"])), thumbDiameterBig + 0.65, function (props) { return Track(props.disabled, props.trackBackground); }, function (props) { return Track(props.disabled, props.trackBackground); }, function (props) { return Track(props.disabled, props.trackBackground); }, function (props) { return 0.5 * (trackHeight - props.currentThumbDiameter); }, 0.5 * (trackHeight - thumbDiameterBig), thumbDiameterBig, thumbDiameterBig, function (props) { return !props.disabled && 0.5 * (trackHeight - thumbDiameterBig); }, function (props) { return !props.disabled && thumbDiameterBig; }, function (props) { return !props.disabled && thumbDiameterBig; }, function (props) { return Thumb(props.disabled, props.currentThumbDiameter, props.thumbBackground); }, function (props) { return Thumb(props.disabled, props.currentThumbDiameter, props.thumbBackground); }, function (props) { return Thumb(props.disabled, props.currentThumbDiameter, props.thumbBackground); });
var Slider = function (props) {
    // This variable is used to make the mobile version work correctly.
    var _a = r$2.useState(false), sliderIsBeingTouched = _a[0], setSliderIsBeingTouched = _a[1];
    var _b = r$2.useState(false), sliderThumbIsBeingTouched = _b[0], setSliderThumbIsBeingTouched = _b[1];
    ...
    return (r__default['default'].createElement(Input, { type: "range", onChange: handleChange, onTouchEnd: handleTouchEnd, onTouchStart: handleTouchStart, currentThumbDiameter: currentThumbDiameter, thumbBackground: props.thumbBackground, trackBackground: props.trackBackground, disabled: props.disabled ? true : false, value: props.value }));
};
Slider.defaultProps = {
    disabled: false,
};
...
var HueSlider = function (props) {
    ...
    return (r__default['default'].createElement(Slider, { disabled: props.disabled, thumbBackground: "hsl(" + props.color.h + ", 100%, 50%)", trackBackground: "linear-gradient(to right, rgb(255, 0, 0),rgb(255, 255, 0),rgb(0, 255, 0),rgb(0, 255, 255),rgb(0, 0, 255),rgb(255, 0, 255),rgb(255, 0, 0))", value: props.color.h / 3.6, handleMoveSlider: handleMoveSlider }));
};

var SaturationSlider = function (props) {
    var handleMoveSlider = function (value) {
        props.handleChangeColor({
            h: props.color.h,
            s: value,
    ...
    return (r__default['default'].createElement(Slider, { disabled: props.disabled, thumbBackground: "hsl(" + props.color.h + ", " + props.color.s + "%, 50%)", trackBackground: "linear-gradient(to right, hsl(" + props.color.h + ", 0%, 50%),  hsl(" + props.color.h + ", 100%, 50%))", value: props.color.s, handleMoveSlider: handleMoveSlider }));
};

var LightnessSlider = function (props) {
    var handleMoveSlider = function (value) {
        props.handleChangeColor({
            h: props.color.h,
            s: props.color.s,
    ...
    return (r__default['default'].createElement(Slider, { disabled: props.disabled, thumbBackground: "hsl(" + props.color.h + ", 100%, " + props.color.l + "%)", trackBackground: "linear-gradient(to right, hsl(" + props.color.h + ", 100%, 0%),  hsl(" + props.color.h + ", 100%, 50%), hsl(" + props.color.h + ", 100%, 100%))", value: props.color.l, handleMoveSlider: handleMoveSlider }));
};

var myImagePath = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAMCAAAAABzHgM7AAAAF0lEQVR42mM4Awb/wYCBYg6EgghRzAEAWDWBGQVyKPMAAAAASUVORK5CYII=";
...
var AlphaSlider = function (props) {
    ...
    return (r__default['default'].createElement(Slider, { disabled: props.disabled, thumbBackground: "linear-gradient(hsla(" + props.color.h + ", 100%, 50%, " + props.color.a + "),  hsla(" + props.color.h + ", 100%, 50%, " + props.color.a + ")), url(" + myImagePath + ")", trackBackground: "linear-gradient(to right, hsla(" + props.color.h + ", 100%, 50%, 0),  hsl(" + props.color.h + ", 100%, 50%)), url(" + myImagePath + ")", value: props.color.a * 100, handleMoveSlider: handleMoveSlider }));
};
