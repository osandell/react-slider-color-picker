import r$2, { useRef, useDebugValue, useContext, createElement, useState } from 'react';
...
var Slider = function (props) {
    ...
    var _a = useState(false), sliderIsBeingTouched = _a[0], setSliderIsBeingTouched = _a[1];
    ...
    return (r$2.createElement(Input, { type: "range", onChange: handleChange, onTouchEnd: handleTouchEnd, onTouchStart: handleTouchStart, currentThumbDiameter: currentThumbDiameter, thumbBackground: props.thumbBackground, trackBackground: props.trackBackground, disabled: props.disabled ? true : false, value: props.value }));
};
Slider.defaultProps = {
    disabled: false,
};
...
var HueSlider = function (props) {
    ...
    return (r$2.createElement(Slider, { disabled: props.disabled, thumbBackground: "hsl(" + props.color.h + ", 100%, 50%)", trackBackground: "linear-gradient(to right, rgb(255, 0, 0),rgb(255, 255, 0),rgb(0, 255, 0),rgb(0, 255, 255),rgb(0, 0, 255),rgb(255, 0, 255),rgb(255, 0, 0))", value: props.color.h / 3.6, handleMoveSlider: handleMoveSlider }));
};
...
var SaturationSlider = function (props) {
    ...
    return (r$2.createElement(Slider, { disabled: props.disabled, thumbBackground: "hsl(" + props.color.h + ", " + props.color.s + "%, 50%)", trackBackground: "linear-gradient(to right, hsl(" + props.color.h + ", 0%, 50%),  hsl(" + props.color.h + ", 100%, 50%))", value: props.color.s, handleMoveSlider: handleMoveSlider }));
};
...
var LightnessSlider = function (props) {
    ...
    return (r$2.createElement(Slider, { disabled: props.disabled, thumbBackground: "hsl(" + props.color.h + ", 100%, " + props.color.l + "%)", trackBackground: "linear-gradient(to right, hsl(" + props.color.h + ", 100%, 0%),  hsl(" + props.color.h + ", 100%, 50%), hsl(" + props.color.h + ", 100%, 100%))", value: props.color.l, handleMoveSlider: handleMoveSlider }));
};
...
var AlphaSlider = function (props) {
    ...
    return (r$2.createElement(Slider, { disabled: props.disabled, thumbBackground: "linear-gradient(hsla(" + props.color.h + ", 100%, 50%, " + props.color.a + "),  hsla(" + props.color.h + ", 100%, 50%, " + props.color.a + ")), url(" + myImagePath + ")", trackBackground: "linear-gradient(to right, hsla(" + props.color.h + ", 100%, 50%, 0),  hsl(" + props.color.h + ", 100%, 50%)), url(" + myImagePath + ")", value: props.color.a * 100, handleMoveSlider: handleMoveSlider }));
};
